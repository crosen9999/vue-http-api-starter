<template>
  ...
  <header style="margin: 0 0 10px 0; font-size: 11pt;">
    <!-- Top Header Bar -->
    <div
      style="display: flex; height: 30px; margin: 0 0 20px 0; background-color: #fff"
    >
      <!-- LOGO -->
      <div
        style="padding: 5px 0 0 20px; font-size: 18pt; margin-left: 10px; color: #ccc"
      >
        <router-link to="/articles" style="color: #aaa">
          Article Database</router-link
        >
      </div>

      <!-- login / logout / greeting -->
      <div style="margin-left: auto; padding: 10px 10px 0px 0px; color: #aaa">
    ...
    <div
      ...
      5px; font-family: helvetica; margin: 0 0 50px 0; text-align: center; border-bottom: 10px solid #ccc"
    >
      <router-link
        :to="{
          name: 'ViewArticle',
      ...
      <router-link :to="{ name: 'ViewC' }" style="margin-right: 30px">
        View C
      </router-link>
    </div>
  </header>
